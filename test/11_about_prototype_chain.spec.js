...
describe("About Prototype Chain (topics/11_about_prototype_chain.js)", function () {
  ...
  it("Who has the masteredJs property?", function() {
    ...
    assert.equal(__,hackagesStudent.masteredJs, "did the hackages student mastered js?");
    assert.equal(__,student.masteredJs, "did the regular student mastered js?");
  });
  ...
  it("Separate proto", function() {
    ...
    assert.equal(davy.technologies.length, __, "Davy should not have learned php");
  })
});
